...
export type MyTestFieldGroup = AcfFieldGroup & AcfFieldGroupFields & MyTestFieldGroup_Fields & {
   ...
   */
  fieldGroupName?: Maybe<Scalars['String']['output']>;
  /** Field of the &quot;text&quot; Field Type added to the schema as part of the &quot;MyTestFieldGroup&quot; Field Group */
  myTestField?: Maybe<Scalars['String']['output']>;
};
...
/** The post type */
export type Post = ContentNode & DatabaseIdentifier & MenuItemLinkable & Node & NodeWithAuthor & NodeWithComments & NodeWithContentEditor & NodeWithExcerpt & NodeWithFeaturedImage & NodeWithRevisions & NodeWithTemplate & NodeWithTitle & NodeWithTrackbacks & Previewable & UniformResourceIdentifiable & WithAcfMyTestFieldGroup & {
  __typename?: 'Post';
  /**
